...
async function onPlayerReady(event)
{
        ...
        console.log(
            {
                ...
                newVl: t.__proto__.newVolume,
                tVol: this?.state?.volume
            }
        );
    }

    function changeVolumeRegardless()
    {
    ...
    t.__proto__.newVolume = validVolume();
    t.__proto__.readyToChangeVolumeOnce = changeVolumeRegardless;
    ...
    if (lastBlockIDParameters.has(blockID))
    {
        ...
        {
            t.__proto__.newVolume = sesion.volume;
        }
    }
        ...
        if (UI.referenced.block_timestamp.checked)
        {
            ...
            for (const i of ytGifs)
            {
                ...
                { //removes at least 'widgetid=··' so they reconize each other
                    ...
                    {
                        t.__proto__.newVolume = desiredVolume;
                    }
